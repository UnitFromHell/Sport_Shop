...
{
    public partial class Sport_ShopContext : DbContext
    {
        public Sport_ShopContext()
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-70TQE1A\\UNITFOMHELL;Initial Catalog=Sport_Shop;Persist Security Info=True;User ID=sa;Password=123");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Manufacture>(entity =>
            {
                ...
                entity.HasIndex(e => e.CompanyName, "UQ_Company_Name")
                    .IsUnique();
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.HasIndex(e => e.OrderNumber, "UQ_Order_Number")
                    .IsUnique();
            ...
            modelBuilder.Entity<TypeProduct>(entity =>
            {
                ...
                entity.HasIndex(e => e.NameType, "UQ_Name_Type")
                    .IsUnique();
